...
export const metadata: Metadata = {
  ...
  title:
    "Health Screening Services in Lagos & Nigeria | Home Health Tests | TriageHome",

  description:
    "TriageHome provides professional health screening services in Lagos and across Nigeria. Get routine health tests, wellness screenings, preventive healthcare assessments, vital checks, and professional home health evaluations delivered directly to your home.",

  keywords: [
    "health screening Lagos",
    "health screening Nigeria",
  ...
  openGraph: {
    title:
      "Professional Health Screening Services | TriageHome",

    description:
      "Professional health screening, preventive healthcare assessments, wellness checks, and routine health evaluations delivered directly to your home.",
  ...
  twitter: {
    ...
    title:
      "Professional Health Screening At Home | TriageHome",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 lg:py-32 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm text-white/80 backdrop-blur-sm">
              <ShieldCheck className="w-4 h-4 text-[#aa7130]" />
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-white/75 font-nunito">
              ...
              Convenient and professional health screening services
            ...
            <div className="mt-12 flex flex-wrap gap-6 text-sm text-white/70">
              ...
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#00b99d]" />
                Routine Health Checks
              </div>

              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#a6d200]" />
                Preventive Screening
              </div>

              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#b745d8]" />
                Wellness Monitoring
              </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[36px] border border-white/10 bg-white/5 shadow-2xl">
              ...
              <img
                ...
                alt="Professional health screening services"
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-slate-600 font-nunito">
              ...
              TriageHome provides convenient health screening
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-5">
              ...
              {benefits.map((benefit, i) => (
                ...
                >
                  ...
                  <CheckCircle2 className="w-5 h-5 text-[#00b99d] mt-0.5" />
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="rounded-[40px] border border-slate-200 bg-white p-10 lg:p-16 shadow-sm">
            ...
            <h2 className="text-4xl font-semibold tracking-tight text-[#02385a] font-raleway">
              ...
              Health Screening Services In Lagos & Nigeria
            ...
            <div className="mt-8 space-y-6 text-lg leading-relaxed text-slate-600 font-nunito">
              ...
              <p>
                TriageHome provides professional health screening services
                in Lagos and across Nigeria, helping individuals access
                convenient preventive healthcare support from home.
              </p>

              <p>
                Our health screening services include routine health checks,
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-6 text-lg text-white/70 leading-relaxed font-nunito">
                  ...
                  Book trusted health screening and wellness monitoring services with TriageHome today.
