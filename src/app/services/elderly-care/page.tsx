...
export const metadata: Metadata = {
  ...
  description:
    "TriageHome provides trusted elderly care services in Lagos and across Nigeria. Get professional caregivers, home nursing, wellness support, medication assistance, companionship, and personalized in-home healthcare for seniors.",
  ...
  openGraph: {
    ...
    description:
      "Trusted in-home elderly care and professional caregivers for seniors. Personalized support, wellness monitoring, companionship, and home healthcare services delivered with compassion.",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 lg:py-32 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-white/75 font-nunito">
              ...
              Professional caregivers and home healthcare support
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <img
              ...
              alt="Trusted caregivers and elderly support services"
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="rounded-[40px] border border-slate-200 bg-white p-10 lg:p-16 shadow-sm">
            ...
            <div className="mt-8 space-y-6 text-lg leading-relaxed text-slate-600 font-nunito">
              ...
              <p>
                Families looking for reliable caregivers for elderly parents
